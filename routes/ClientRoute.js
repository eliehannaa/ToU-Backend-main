...
router.post(
  "/client/home/searchproduct/:asin/:quantity",
  requireAuth,
  productController.productrequest_post
);
...
router.get(
  "/client/home/pendingorders",
  requireAuth,
  clientController.getPendingClient_get
);
//Client gets list of pending orders

router.get(
  "/client/home/activeorders",
  requireAuth,
  clientController.getActiveClient_get
);
//Client gets list of active orders

router.get(
  "/client/home/activeorders/:orderid",
  clientController.getActiveOrder_get
);
...
router.post(
  "/client/home/profile/edit/changepassword",
  requireAuth,
  clientController.changePass_post
);

router.post(
  "/client/home/activeorder/:orderid/markascomplete",
  requireAuth,
  clientController.complete_order_post
);
//Client completes order

router.post(
  "/client/home/activeorder/:orderid/markascomplete/feedback",
  requireAuth,
  clientController.giveFeedback_post
);
...
//Contact Forms
router.post(
  "/client/home/contactform",
  requireAuth,
  clientController.submitContactForm
);

...
router.get(
  "/admin/activeorders/:orderid/downloadproof",
  adminController.download_proof_get
);
router.post(
  "/admin/activeorders/:orderid/updatestatus",
  adminController.update_delivery_status_post
);
router.post(
  "/admin/activeorders/:orderid/rejectproof",
  adminController.rejectProof_post
);
...
router.post(
  "/admin/pendingorders/:orderid/reject",
  adminController.rejectorder_post
);
...
router.post(
  "/admin/waitingorders/:orderid/revoke",
  adminController.revoke_order_post
);
// //admin can withdraw the order from a traveler if he thinks that the traveler is taking too long to get a response

router.post(
  "/admin/pendingorders/:orderid/setcost",
  adminController.setcost_post
);
// //If there is no cost by default, admin adds it manually

router.get(
  "/admin/pendingorders/:orderid/activetravelers",
...
router.post(
  "/admin/pendingorders/:orderid/activetravelers/:travelerid/assign",
  adminController.assign_order_post
);
...
router.get("/admin/home/newtravelers", adminController.getNewTravelers_get);

router.post(
  "/admin/home/newtravelers/:id/accept",
  adminController.acceptTraveler_post
);

router.get("/admin/travelers/:travelerid");

router.post(
  "/admin/travelers/:travelerid/revokeaccess",
  adminController.revoke_access_post
);

router.post(
  "/admin/home/travelers/:travelerid/ban",
  adminController.deleteTraveler
);

router.get(
  "admin/home/travelers/revokedtravelers",
  adminController.getrevoked_list
);

router.get(
  "admin/home/travelers/revokedtravelers/:travelerid",
  adminController.getrevokedTraveler_get
);

router.post(
  "admin/home/travelers/revokedtravelers/:travelerid/unrevoke",
  adminController.unrevoke_post
);
